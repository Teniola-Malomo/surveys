...
# Prompt for email
read -p "Enter your TCD email address (e.g., yourname@tcd.ie): " TCD_EMAIL
if [ -z "$TCD_EMAIL" ]; then
...
<body>
    ...
    <div class="contact">
        ...
        <p><strong>Email:</strong> $TCD_EMAIL</p>
...
echo "   - Change A record from 195.7.226.12 to $IPV4"
echo "   - Add TXT record:"
echo "     \"TCD crypto key survey research. Contact: $TCD_EMAIL. More: http://tcd-student-research.ie/about-scan.html\""
echo ""
echo "2. Contact Hetzner to enable outbound port 25:"
echo "   - Your scans found 0 results because port 25 is blocked"
echo "   - Email: support@hetzner.com"
echo "   - Explain: Academic research scanning (non-spam)"
echo ""
echo "3. Wait 1-2 hours for DNS propagation, then verify:"
echo "   dig +short tcd-student-research.ie A"
echo "   curl http://tcd-student-research.ie/about-scan.html"
echo ""
echo "4. Test port 25 connectivity:"
